...
class wifi_connector:
    ...
    def __init__(self, id, host):
        self.__id = id
        if self.__id == CLIENT:           
            HOST = host # server IP or Hostname (found at terminal: $ hostname -I)
	...
	elif self.__id == SERVER:
	    HOST = host # should be left empty ''
            ...
            self.__conn, address = self.__server.accept()
